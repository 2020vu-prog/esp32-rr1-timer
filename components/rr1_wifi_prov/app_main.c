...
static void event_handler(void *arg, esp_event_base_t event_base,
  ...
  if (event_base == WIFI_PROV_EVENT) {
    ...
    case WIFI_PROV_CRED_FAIL: {
       ...
       * This is enabled by the CONFIG_EXAMPLE_RESET_PROV_MGR_ON_FAILURE
       * configuration. It allows the provisioning manager to retry the
       * provisioning process based on the number of attempts specified in
       * wifi_conn_attempts. After attempting the maximum number of retries, the
       * provisioning manager will reset the state machine and the provisioning
...
void wifi_prov_app_callback(void *user_data, wifi_prov_cb_event_t event,
                            void *event_data) {
  /**
   * This is blocking callback, any configurations that needs to be set when a
   * particular provisioning event is triggered can be set here.
   */
  switch (event) {
